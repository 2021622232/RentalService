...
<%--&lt;%&ndash;                            <option value="${teacher.t_college}" selected>${teacher.t_college}</option>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                            <option value="${teacher.t_department}" selected>${teacher.t_department}</option>&ndash;%&gt;--%>
<%--                                <option value="" selected></option>--%>
...
<%--&lt;%&ndash;                            <option value="${teacher.t_class}" selected>${teacher.t_class}</option>&ndash;%&gt;--%>
<%--                            <option value="" selected></option>--%>
